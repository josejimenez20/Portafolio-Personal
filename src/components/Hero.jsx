  ...
  return (
    <section id="inicio" className="w-full max-w-7xl mx-auto px-6 md:px-16 min-h-[calc(100vh-1px)] flex flex-col-reverse md:flex-row items-center justify-center md:justify-between gap-8 md:gap-12 py-8 md:py-0">
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left space-y-5">
        ...
        <div className="bg-blue-50 text-blue-600 px-5 py-2 rounded-full text-sm font-semibold tracking-wide shadow-sm">
          {t?.etiqueta}
        </div>
        ...
        {/* Botones Dinámicos (MEJORADOS CON HOVER) */}
        <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
          {/* Botón Principal */}
          <a href="#contacto" className="bg-blue-300 hover:bg-blue-400 hover:-translate-y-1 text-slate-900 font-semibold py-3 px-8 rounded-xl transition-all duration-300 shadow-md hover:shadow-xl flex items-center gap-2">
            {t?.botonContacto}
          </a>
          ...
          <a 
            ...
            className="bg-white hover:bg-slate-50 hover:-translate-y-1 text-slate-700 border border-slate-200 font-medium py-3 px-8 rounded-xl transition-all duration-300 shadow-sm hover:shadow-md flex items-center gap-2 w-fit"
          >
            {t?.botonCv}
        ...
        {/* Contenedor de Iconos (Redes Sociales - MEJORADOS) */}
        <div className="flex items-center justify-center md:justify-start gap-5 pt-4">
          <a href="https://github.com/josejimenez20" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-blue-600 hover:-translate-y-1 transition-all duration-300">
          ...
          <a href="https://www.linkedin.com/in/josé-heinar-jiménez-reyes-0597aa3b2" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-blue-600 hover:-translate-y-1 transition-all duration-300">
          ...
          <a href="mailto:jimenezheinar8@gmail.com" className="text-slate-600 hover:text-blue-600 hover:-translate-y-1 transition-all duration-300">
      ...
      <div className="w-full md:w-1/2 flex justify-center md:justify-end">
        <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full shadow-2xl bg-slate-50/50 flex-shrink-0 ring-4 ring-blue-50 ring-offset-4">
          <img 
            src="/mi-foto.jpg"
