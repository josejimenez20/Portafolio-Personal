  ...
  return (
    <section id="sobre-mi" className="w-full max-w-7xl mx-auto px-8 md:px-16 py-20 bg-slate-50">
      <div className="flex flex-col md:flex-row items-center gap-16">
        ...
        {/* Columna Izquierda: Imagen estilo Figma */}
        <div className="w-full md:w-1/2">
          {/* Le añadí una sutil rotación que se endereza al pasar el mouse para darle un toque premium */}
          <div className="relative rounded-2xl overflow-hidden shadow-2xl transform -rotate-1 hover:rotate-0 transition-transform duration-500">
            {/* Imagen de laptop (Puedes cambiar el enlace luego por tu propia foto) */}
            <img 
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start">
          ...
          {/* <div className="space-y-4 text-slate-600 leading-relaxed">
            <p>
              Soy un apasionado desarrollador y estudiante de ingeniería con un fuerte enfoque en crear soluciones tecnológicas integrales. Mi viaje en la tecnología comenzó explorando el hardware y las redes, y desde entonces he expandido mis habilidades hacia el desarrollo de software y la infraestructura.
            </p>
            <p>
              Creo firmemente en el aprendizaje continuo y en la importancia de mantenerse actualizado con las últimas tendencias tecnológicas. Cuando no estoy programando, me gusta explorar la electrónica, configurar servidores o investigar sobre inteligencia artificial aplicada.
            </p>
          </div>
            */}
          ...
          <div className="grid grid-cols-2 gap-8 mt-10 w-full border-t border-slate-200 pt-8">
            <div>
              ...
              <p className="text-sm text-slate-600 font-medium">Ingeniería en Sistemas</p>
